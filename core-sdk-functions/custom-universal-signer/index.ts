...
async function main() {
  ...
  // 2.3 signMessage
  const customSignTypedData = async ({ domain, types, primaryType, message }: any) => {
...
async function optionalPushChainClientAndSendTx(universalSigner: UniversalSigner) {
  // setup for input
